...
(In the project notebook, this same simulation also feeds an optional
animated FuncAnimation cell showing the drone chasing the figure-eight
target live.)
"""
...
def plot_result(xs, ys, save=True, filename="figure_eight_drone_tracking.png"):
...
if __name__ == "__main__":
    xs, ys = simulate()
    plot_result(xs, ys, save=True, filename="figure_eight_drone_tracking.png")
