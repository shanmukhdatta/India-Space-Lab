# Project 2: Advanced Drone Technology (Guidance & Control) — ISL Summer Internship Report
...
*See also: Dedicated project folder [`Drone_Project/`](Drone_Project/) and standalone documentation [`Drone_Project/README.md`](Drone_Project/README.md).*
...
|---|---|---|
| Task 1 — PID altitude control | ✅ Complete | `task1_drone_pid.py` |
| Task 2 — Boat guidance (with/without current) | ✅ Complete | `task2_boat_guidance.py` |
| Bonus — Figure-eight trajectory | ✅ Complete | `bonus_figure_eight_drone.py` |
| Jupyter notebook (all tasks combined) | ✅ Complete | `Advanced_Drone_Technology_Project.ipynb` |
| Output plots (4 PNGs) | ✅ Generated | `pid_tuning_result.png`, `boat_guidance_*.png`, `figure_eight_*.png` |
| Project Report (`.docx`) | ✅ Complete | `Guidance_and_Control_Project_Report.docx` |
